        ...
        <div className="max-w-[1390px] mx-auto sm:px-10">
          ...
          <div className="flex items-center justify-between gap-10 mx-16 my-28 flex-col lg:flex-row">
            ...
            <div className="rounded-3xl w-96 h-auto overflow-hidden border-4 border-black md:h-auto sm:w-96 lg:w-[840px] sm:h-auto">
              <iframe
                ...
                className="w-[380px] h-[280px] md:w-[400px] md:h-[300px] lg:w-[840px] lg:h-[525px]"
                frameborder="0"
                allowFullScreen
                allow="autoplay"
              ></iframe>
          ...
          <div className="flex items-center justify-between gap-10 my-28 flex-col">
            ...
            <div className="flex flex-col gap-8 mx-16 md:flex-row">
              <Link href="">
                <div className="rounded-3xl w-96 h-auto overflow-hidden border-4 border-black md:h-auto lg:w-auto sm:w-96 sm:h-auto">
                  <img src="/283.jpg" />
                </div>
              </Link>
